...
/*
 * [DuberEatz1.java]
 * This program is the solution to the Duber Eatz Assignment for levels 1, 2, 3 and 4
 * Authour: Braydon Wang
 * Date: 11/06/2019
*/

public class DuberEatz1 {
 static int row;
 static int column;
 ...
 public static void main(String[] args) throws Exception {
     ...
     for (int i = 0; i < allPermutations.size(); i++) {
       ...
       //Updating the minimum distance and the final map if it finds a shorter path
